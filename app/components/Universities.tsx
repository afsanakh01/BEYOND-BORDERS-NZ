  ...
  return (
    <section id="universities" style={{ background: "#0c0c0c", padding: "8rem 4rem" }}>
      <p style={{
        ...
        color: "rgba(250,250,248,0.5)", marginBottom: "1rem",
        ...
        {unis.map((u, i) => (
          <div key={i} style={{
            ...
            onMouseEnter={e => {
              ...
              if (btn) { btn.style.background = "#FAFAF8"; btn.style.color = "#0c0c0c"; }
            }}
            onMouseLeave={e => {
              const bg = e.currentTarget.querySelector(".ubg") as HTMLElement;
              const desc = e.currentTarget.querySelector(".udesc") as HTMLElement;
              ...
              if (btn) { btn.style.background = "transparent"; btn.style.color = "#FAFAF8"; }
            }}
          >
            <div className="ubg" style={{
              position: "absolute", inset: 0,
              background: u.bg,
              backgroundImage: u.img ? `url('${u.img}')` : undefined,
            ...
            <div style={{
              position: "absolute", inset: 0,
              background: "linear-gradient(to top,rgba(12,12,12,0.97) 0%,rgba(12,12,12,0.3) 55%,transparent 100%)",
            }} />
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "2.2rem" }}>
              <p style={{
                fontFamily: "'Inter', sans-serif", fontSize: "0.58rem",
                letterSpacing: "0.3em", textTransform: "uppercase",
                color: "rgba(250,250,248,0.6)", marginBottom: "0.5rem",
              }}>{u.tag}</p>
              <h3 style={{
                fontFamily: "'Playfair Display', serif",
              ...
              <p style={{
                ...
                color: "rgba(250,250,248,0.6)", marginBottom: "0.8rem",
              }}>{u.tagline}</p>
